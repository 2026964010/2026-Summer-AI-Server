...
- 장시간 사용시 답변 끊김 문제 발견. -> 컨텍스트(num_ctx) 크기 수정 (16,384 -> 32,768)
- 이미지 생성시 도구 호출 안정성 소규모 테스트 -> 모두 다른 채팅방에서 다른 유형의 프롬프트로 10회 테스트 -> 10/10 모두 호출 성공
